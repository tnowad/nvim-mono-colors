...
local function set_groups()
	local groups = {
		...
		Comment = { fg = colors.ui_separator, italic = true },

		Constant = { fg = colors.messages_error },
		String = { fg = colors.messages_warning, italic = true },
		...
		Keyword = { link = "Statement", italic = true },
		...
		["@variable"] = { fg = colors.text_primary, italic = true },
		["@variable.builtin"] = { fg = colors.text_primary, italic = true },
		["@type"] = { link = "Type" },
